<header class="main-header">
    ...
    <a href="{{ route('frontend.index') }}" class="logo" style="padding: 0px">
        ...
        <img height="50px" width="230px" src="{{asset('/img/logo.jpg')}}">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ url('storage/'.access()->user()->avatar) }}" class="user-image" alt="User Avatar"/>
                        <span class="hidden-xs">{{ access()->user()->full_name }}</span>
                    </a>

                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="{{ url('storage/'.access()->user()->avatar) }}" class="img-circle" alt="User Avatar" />
                            <p>
                        ...
                        <li class="user-body">
                            <div class="col-xs-6 text-center" style="border-right: 1px solid #3c8dbc">
                                <a href="{{ url('admin/personnel/users/view/'.access()->user()->id) }}">View</a>
                            </div>
                            <div class="col-xs-6 text-center">
                                <a href="{{ url('admin/personnel/users/edit/'.access()->user()->id) }}">Change Profile</a>
                            </div>
