...
Route::group([
    ...
    Route::group([
        ...
        * Permission Route
        */
        Route::group(['namespace' => 'Permission','prefix' => 'permission', 'as' => 'permission.'], function () {
            Route::get('/', 'PermissionController@getPermission')->name('index');

            Route::group(['middleware' => 'access.routeNeedsRole:Kỹ thuật'], function() {
                Route::get('add', 'PermissionController@getAdd')->name('getAdd');
                Route::post('add', 'PermissionController@postAdd')->name('postAdd');

                Route::get('delete/{id}', 'PermissionController@getDelete')->name('getDelete');

                Route::get('edit/{id}', 'PermissionController@getEdit')->name('getEdit');
                Route::post('edit/{id}', 'PermissionController@postEdit')->name('postEdit');
            });
        });
